...
import (
	toolkit "github.com/buildpacks/github-actions/toolkit"
	mock "github.com/stretchr/testify/mock"
)

// Toolkit is an autogenerated mock type for the Toolkit type
type Toolkit struct {
	mock.Mock
}

// AddMask provides a mock function with given fields: mask
func (_m *Toolkit) AddMask(mask string) {
	_m.Called(mask)
}

// AddPath provides a mock function with given fields: paths
func (_m *Toolkit) AddPath(paths ...string) error {
...
func (_m *Toolkit) Debug(a ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, a...)
	_m.Called(_ca...)
}
...
func (_m *Toolkit) Debugf(format string, a ...interface{}) {
	var _ca []interface{}
...
func (_m *Toolkit) EndGroup() {
	_m.Called()
}

// Error provides a mock function with given fields: a
func (_m *Toolkit) Error(a ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, a...)
	_m.Called(_ca...)
}
...
func (_m *Toolkit) Errorc(context toolkit.MessageContext) {
	_m.Called(context)
}

// Errorf provides a mock function with given fields: format, a
func (_m *Toolkit) Errorf(format string, a ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, format)
	_ca = append(_ca, a...)
	_m.Called(_ca...)
...
func (_m *Toolkit) ExportVariable(name string, value string) error {
...
func (_m *Toolkit) GetInput(name string) (string, bool) {
	ret := _m.Called(name)
...
func (_m *Toolkit) GetState(name string) (string, bool) {
	ret := _m.Called(name)
...
func (_m *Toolkit) Warningc(context toolkit.MessageContext) {
	_m.Called(context)
}

// Warningf provides a mock function with given fields: format, a
func (_m *Toolkit) Warningf(format string, a ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, format)
	_ca = append(_ca, a...)
	_m.Called(_ca...)
