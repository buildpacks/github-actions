...
func (_m *MockOrganizationsService) List(ctx context.Context, user string, opts *github.ListOptions) ([]*github.Organization, *github.Response, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *github.ListOptions) ([]*github.Organization, *github.Response, error)); ok {
...
// NewMockOrganizationsService creates a new instance of MockOrganizationsService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockOrganizationsService(t interface {
	mock.TestingT
	Cleanup(func())
